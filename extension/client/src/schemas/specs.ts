...
export const specs: { [spec: string]: SpecFieldDef[] } = {
  ...
  IJ: [
    { start: 30, end: 33, name: `Date/Time Format`, id: `dateTimeFormat` },
    { start: 34, end: 34, name: `Date/Time Separator`, id: `separator` },
    { start: 35, end: 35, name: `Data Type`, id: `dataType` },
    { start: 36, end: 39, name: `From Position`, id: `fromPos`, padStart: true },
    { start: 41, end: 44, name: `To Position`, id: `toPos`, padStart: true },
    { start: 46, end: 46, name: `Decimal Positions`, id: `decimals`, padStart: true },
    { start: 48, end: 61, name: `Field Name`, id: `fieldName` },
    { start: 62, end: 63, name: `Level`, id: `level` },
    { start: 64, end: 65, name: `Matching / Control`, id: `matching` },
    { start: 66, end: 67, name: `Field Relation`, id: `fieldRelation` },
    { start: 68, end: 69, name: `Plus Indicator`, id: `plusInd` },
    { start: 70, end: 71, name: `Minus Indicator`, id: `minusInd` },
    { start: 72, end: 73, name: `Zero Indicator`, id: `zeroInd` },
  ],
  IX: [
...
export const opmSpecRulers: { [spec: string]: string } = {
  ...
  C: `.....CL0N01N02N03Factor1+++OpcdeFactor2+++ResultLenDXHiLoEq............`,
